...
/// Returns a Classification object following the Jenks Natural Breaks algorithm given the desired number of bins and one-dimensional f64 data (note: the maximum number of bins generated by this algorithm is the number of unique values in the dataset)
///
/// # Arguments
///
...
/// Returns a vector of breaks generated through the Jenks Natural Breaks algorithm given the desired number of bins and a dataset (note: the maximum number of bins generated by this algorithm is the number of unique values in the dataset)
///
/// # Arguments
///
