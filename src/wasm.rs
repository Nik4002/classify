...
// ...TO HERE ONCE EVERYTHING HAS BEEN TESTED
...
#[wasm_bindgen]
pub fn get_jenks_classification(no_bins: usize, data: &[f64]) -> JSClassification { // What's the benefit of using JsValue instead of JSClassification here?
